...
def route_agent_result(result: dict[str, Any]) -> dict[str, Any]:
    ...
    route_map = {
        "SUSPENDED_SCHEMA_VALIDATION": "VALIDATION_QUEUE",
        ...
        "SUSPENDED_MEDICAL_NECESSITY": "CLINICAL_DIRECTOR_QUEUE",
        "SUSPENDED_JUDGE_REVIEW": "CLINICAL_DIRECTOR_QUEUE",
