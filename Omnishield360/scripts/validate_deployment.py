...
EXPECTED_FILES = [
    ...
    REPO_ROOT / "case_workers.py",
    REPO_ROOT / "case-models" / "case-entity-schema.json",
    REPO_ROOT / "case-models" / "omnishield360-case-plan.json",
    REPO_ROOT / ".github" / "workflows" / "deploy.yml",
    REPO_ROOT / "docs" / "deployment.md",
    REPO_ROOT / "docs" / "MAESTRO_CASE_BUILD_GUIDE.md",
